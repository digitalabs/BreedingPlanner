...
public class ModifyWizardPageMABC extends WizardPage {
	private Shell sShell = null;
	private ModifyCompositeMABC mc;
	public ModifyCompositeMABC getIc() {
		return mc;
	}

	protected ModifyWizardPageMABC(String pageName, String title,
	...
	public void createControl(Composite arg0) {
		...
		mc = new ModifyCompositeMABC(arg0,SWT.NONE,sShell);
		setControl(mc);
	}
