...
public class ModifyCompositeMABC extends Composite {
...
//		gridData.verticalAlignment = SWT.CENTER;
	...
	//	label11.setText("Label");
		...
		combo16.setText(inputInfoList.get(11).getValue());
		combo17.setText(inputInfoList.get(12).getValue());
...
//	}
	...
	private void createCombo16() {
		...
		gridData26.widthHint = 65;
		GridData gridData6 = new GridData();
		gridData6.horizontalAlignment = org.eclipse.swt.layout.GridData.BEGINNING;
		gridData6.widthHint = 65;
		combo16 = new Combo(group, SWT.READ_ONLY);
		combo16.add("1");
		combo16.add("2");
		combo16.add("3");
		combo16.setText("1");
		combo16.setLayoutData(gridData26);
	}
