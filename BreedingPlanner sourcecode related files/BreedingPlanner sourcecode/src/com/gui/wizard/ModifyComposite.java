...
public class ModifyComposite extends Composite {
	...
	private GridData widthGridData = null;  //  @jve:decl-index=0:
	...
	public String PhenoText;  //  @jve:decl-index=0:
	public ModifyComposite(Composite parent, int style, Shell sShell) {
		super(parent, style);
		this.sShell = sShell;
		initialize();
	}

	private void initialize()//框体初始化
	{
		...
		PhenoText=inputInfoList.get(11).getValue();//初始化phenotype = F3
		widthGridData = new GridData();
		widthGridData.widthHint = 62;//后面下拉按钮使用，GeneType、phenotype两个按钮使用
...
//		gridData.verticalAlignment = SWT.CENTER;
		...
		text1.setText(inputInfoList.get(0).getValue());//Country
		text2.setText(inputInfoList.get(1).getValue());//Researcher`s name
		combo.setText(inputInfoList.get(2).getValue());//Crop species
		//text5.setText(inputInfoList.get(3).getValue());
		spinner1.setSelection(Integer.parseInt(inputInfoList.get(3).getValue()));//Expected seeds per plant
		//text9.setText(inputInfoList.get(4).getValue());
		spinner2.setSelection(Integer.parseInt(inputInfoList.get(4).getValue()));//Length of each season
		
		String val=inputInfoList.get(5).getValue();//Seasons per year
		combo12.setText(val);
		...
		combo13.setText(inputInfoList.get(6).getValue());//1st season starts in
		combo14.setText(inputInfoList.get(7).getValue());//2st season starts in
		combo15.setText(inputInfoList.get(8).getValue());//3rd season starts in
		dateTime1.setYear( GetYear(inputInfoList.get(9).getValue()));//parental generation starts in
		dateTime1.setMonth(GetMonth(inputInfoList.get(9).getValue()));//出现问题
		
		combo3.setText(inputInfoList.get(10).getValue());//Generation for genotyping
		/*                                                 //先隐藏
		...
		*/
		combo6.setText(inputInfoList.get(11).getValue());//Generation for phenotyping
        ...
        text3.setText(inputInfoList.get(13).getValue());//Number of locations
		combo4.setText(inputInfoList.get(14).getValue());//Replicates in each location
        text4.setText(inputInfoList.get(15).getValue());//Plot length
        text6.setText(inputInfoList.get(16).getValue());//Number of rows
        text7.setText(inputInfoList.get(17).getValue());//individual plants per plot
		combo5.setText(inputInfoList.get(18).getValue());//Rounds of selfing after inter-mating
	}
		...
		combo3.addSelectionListener(new org.eclipse.swt.events.SelectionListener() {
			public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
				if(combo3.getSelectionIndex()==0)
				{
					...
					combo6.add("F4");
					combo6.add("F5");
					if(PhenoText.equals("F3")||PhenoText.equals("F4")||PhenoText.equals("F5"))
					{
						combo6.setText(PhenoText);
					}
					else
					{
						combo6.setText("F3");
					...
					combo6.add("F5");
					combo6.add("F6");
					if(PhenoText.equals("F4")||PhenoText.equals("F5")||PhenoText.equals("F6"))
					{
						combo6.setText(PhenoText);
					}
					else
		...
		text.addVerifyListener(new org.eclipse.swt.events.VerifyListener() {
			public void verifyText(org.eclipse.swt.events.VerifyEvent e) {
				if(e.text.endsWith(".mars")){
					...
					if(inputInfoList.get(12).getValue()=="Greenhouse/offseason")
					{
						radioButton2.setSelection(true);
