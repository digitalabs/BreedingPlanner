...
public class InputCompositeMAS extends Composite {

	private List<InputInfoItem> inputInfoList=null;  //  @jve:decl-index=0:
	
	public List<InputInfoItem> getInputInfoItems()
	{
	...
	public InputCompositeMAS(Composite parent, int style, Shell sShell) {
		super(parent, style);
		this.sShell = sShell;
		initialize();
...
//		gridData.verticalAlignment = SWT.CENTER;
	...
	//	label11.setText("Label");
		...
		label.setText("");
		this.setSize(new Point(632, 474));
	...
	private void createDateTime1() {
	 ...
	 private void setList(){
		...
		inputInfoList = new ArrayList<InputInfoItem>();
